...
public class BinaryTree<T>
{
    ...
    // ----------------------------------------------------------
    /**
     * Size takes no parameters
     *
     * @return size of this tree
     */
    public int size() // this may not be allowed
    {
        int size = 1;
    ...
    public String toPreOrderString()
    {
        ...
        // builder.append("(");
        builder.append(getElement().toString());
        builder.append(" ");
        if (left != null)
        {
            builder.append(getLeft().toPreOrderString());
            // Add a space before the next element
            // builder.append(" ");
        }
        if (right != null)
        {
            builder.append(getRight().toPreOrderString());
            // Add a space before the next element
            // builder.append(" ");
        }
